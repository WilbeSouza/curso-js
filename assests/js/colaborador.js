...
const modal = new boostrap.modal(document.getElementById("exampleModal"));
...
function listarColaboradores() {
    ...
    colaboradores.forEach((colaborador) => {criarLinha(colaborador);})
 }
...
function criarLinha(colaborador){
    ...
    let linha = ` <tr>
                        ...
                        <td>
                            <button class="btn btn-primary" onclick="editar(${colaborador.id})><i class="fa-solid fa-pen-to-square"></i>
                                Editar</button>
...
function popularCamposParaEditar(colaboradorId) {
    ...
    campoQuantidadeHoras.value = colaborador.quanidadeHoras;
...
function editar() {
    ...
    colaborador.quanidadeHoras = campoQuantidadeHoras.value
